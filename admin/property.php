      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <a href="property/property_approval.php" class="btn btn-primary mt-auto">Open</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text text-muted">Change a property status.</p>
            <a href="property/property_status.php" class="btn btn-primary mt-auto">Open</a>
          </div>
        </div>
      </div>
    </div>
