        ...
        <div class="card h-100 border-primary">
          <div class="card-body d-flex flex-column">
            <div class="d-flex align-items-center justify-content-between mb-2">
              <h5 class="card-title mb-0">Footer Update</h5>
              <i class="bi bi-gear card-icon text-primary"></i>
            </div>
            <p class="card-text text-muted">Manage footer details and links.</p>
            <a href="footer/footer_update.php" class="btn btn-primary mt-auto">Open</a>
          </div>
        </div>
      </div>
