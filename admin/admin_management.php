...
<body>
  ...
  <h3><?php echo $editItem ? 'Edit Admin' : 'Create Admin'; ?></h3>
  <form method="post">
    ...
    <?php if ($editItem): ?>
      <a class="button" href="admin_management.php">Cancel</a>
    <?php endif; ?>
  </form>
    ...
    <tbody>
      <?php foreach ($list as $row): ?>
        <tr>
          ...
          <td>
            <a class="button" href="admin_management.php?action=edit&user_id=<?php echo (int)$row['user_id']; ?>">Edit</a>
            <a class="button" href="admin_management.php?action=delete&user_id=<?php echo (int)$row['user_id']; ?>" onclick="return confirm('Delete this admin?');">Delete</a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
