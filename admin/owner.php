      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text text-muted">Change an owner status.</p>
            <a href="owner/owner_status.php" class="btn btn-primary mt-auto">Open</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card h-100">
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text text-muted">Manage owners' bought packages.</p>
            <a href="owner/owner_bought_package_management.php" class="btn btn-primary mt-auto">Open</a>
          </div>
        </div>
      </div>
    </div>
